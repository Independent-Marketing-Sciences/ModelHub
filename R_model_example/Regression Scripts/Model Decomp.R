...
if(regApproach != "bayesian"){
  ...
  fitted_values <- bay_fitted_values
  ...
  varsVIFToExport <- rep(NA,length(coeff))
...
if (regApproach == "bayesian" && baySoftware == "r"){
...
regVarDetailsStackedDf <- regVariableDetailsDf %>%
  select(c("Code", "Variable", "Coefficient", "StandardError", "tStat", "pValue", "Rhat", "RatioEss", "VIF")) %>%
  `colnames<-`(c("Code", "Variable", "1.Coefficient", "4.StandardError", "2.tStat", "3.pValue", "5.Rhat", "6.RatioESS", "7.VIF")) %>%
  cbind(modVarByXsNamesFin[ , c("varCodeWoXs", "Variable", paste("dum.", xsNames, sep = ""))]) %>%
  reshape(direction = "long", 
          varying = c("1.Coefficient", "4.StandardError", "2.tStat", "3.pValue", "5.Rhat", "6.RatioESS", "7.VIF"),
          v.names = "Value",
          idvar = c("VarName"),
          timevar = "Metric",
          times = c("1.Coefficient", "4.StandardError", "2.tStat", "3.pValue", "5.Rhat", "6.RatioESS", "7.VIF"))
